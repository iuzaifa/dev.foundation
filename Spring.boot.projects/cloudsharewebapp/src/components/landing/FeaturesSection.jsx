...
const FeaturesSection = ({ features }) => {
  const renderIcons = (iconName, iconColor) => {
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      <div className="inline-flex items-center justify-center p-3 bg-white rounded-sm shadow-md">
                        {renderIcons(feature.iconName, feature.iconColor)}
                      </div>
